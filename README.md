...
[more info on github provider configuration](https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/creating-an-oauth-app)

[for more info](https://authjs.dev/getting-started/providers/github)
